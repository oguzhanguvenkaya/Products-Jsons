...
const MASTER = resolve(PROJECT_ROOT, 'output', 'csv', 'products_master.csv');
const SPECS = resolve(PROJECT_ROOT, 'output', 'csv', 'product_specs.csv');
const CONTENT = resolve(PROJECT_ROOT, 'output', 'csv', 'product_content.csv');
const FAQ = resolve(PROJECT_ROOT, 'output', 'csv', 'product_faq.csv');
