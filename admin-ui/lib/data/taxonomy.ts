...
export const TAXONOMY: TemplateGroup[] = [
  ...
  },
  {
    ...
    total: 30,
    subs: [
      { sub: "fabric_leather_cleaner", count: 9 },
      { sub: "plastic_dressing", count: 6 },
      { sub: "multi_surface_apc", count: 4 },
      { sub: "fabric_protector", count: 3 },
      { sub: "leather_cleaner", count: 3 },
      { sub: "leather_care_kit", count: 2 },
      { sub: "leather_dressing", count: 2 },
      { sub: "antibacterial_treatment", count: 1 },
    ],
  },
  {
